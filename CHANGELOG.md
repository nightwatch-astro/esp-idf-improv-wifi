...
## [0.3.0](https://github.com/nightwatch-astro/esp-idf-improv-wifi/compare/v0.2.4...v0.3.0) - 2026-07-17

### Features

- relicense to MPL-2.0 and require CLA ([#29](https://github.com/nightwatch-astro/esp-idf-improv-wifi/pull/29))
